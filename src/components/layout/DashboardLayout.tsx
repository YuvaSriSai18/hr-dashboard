...
import { Home, Users, Bookmark, BarChart2, Settings, LogOut, Sun, Moon, UserPlus } from 'lucide-react';
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <SidebarProvider defaultOpen>
      <Sidebar variant="sidebar" collapsible="icon" className="border-r">
        <SidebarHeader className="p-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group-data-[collapsible=icon]:hidden">
            ...
            <h1 className="text-xl font-semibold text-foreground">HR Glimpse</h1>
          </Link>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
             ...
             <SidebarMenuItem>
                <SidebarMenuButton onClick={() => setIsCreateUserModalOpen(true)} tooltip="Create User">
                    <UserPlus />
      ...
      <SidebarInset>
        <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-background/80 backdrop-blur-sm px-4 md:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Avatar>
              <AvatarImage src="https://t3.ftcdn.net/jpg/09/48/09/30/360_F_948093078_6kRWXnAWFNEaakRMX5OM9CRNNj2gdIfw.jpg" alt="HR Manager" data-ai-hint="user avatar" />
      ...
      <CreateUserModal isOpen={isCreateUserModalOpen} onOpenChange={setIsCreateUserModalOpen} />
    </SidebarProvider>
  );
}
